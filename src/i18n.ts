...
const messages = {
  ...
  ru: {
    ...
    compact: 'Компактные ссылки', layout: 'Режим ссылок', orbit: 'Орбита', smartTiles: 'Умная плитка', opened: 'Открыто', automation: 'Автоматические ссылки', autoAddTopSites: 'Добавлять часто посещаемые сайты', autoAddTopSitesHint: 'Берёт список популярных сайтов из браузера; Radial не отправляет его на свои серверы.', permissionRequired: 'Разрешение браузера не предоставлено', data: 'Ваши данные', export: 'Экспортировать', import: 'Импортировать', reset: 'Сбросить настройки',
